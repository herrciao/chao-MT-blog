...
export const metadata: Metadata = {
  title: '關於我',
  description: '了解更多關於 Chao 的背景、經驗和這個部落格的故事。',
  alternates: {
    canonical: '/about',
    languages: {
      'zh-TW': '/about',
            ...
            <div className="lg:col-span-2">
              <div className="space-y-6">
                <p className="text-xl text-gray-600 leading-relaxed">
                  你好！我是 Chao，一位熱愛技術與創新的軟體開發者。歡迎來到我的數位空間，
                  在這裡我分享我在程式設計、產品開發和生活中的學習與思考。
                </p>
                ...
                <p className="text-gray-700 leading-relaxed">
                  我在軟體開發領域有超過 X 年的經驗，專精於前端開發、全端架構設計和產品策略。
                  我曾經參與過多個大型專案，從新創公司的MVP開發到企業級應用的架構設計，
                  這些經驗讓我對技術和產品都有了深刻的理解。
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">前端開發</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">後端開發</h3>
                    <ul className="text-gray-700 space-y-1">
                ...
                <p className="text-gray-700 leading-relaxed">
                  我相信知識分享的力量。通過寫作，我不僅能夠整理自己的思緒和學習心得，
                  也希望能夠幫助其他人解決問題或獲得啟發。這個部落格是我記錄成長軌跡、
                  分享實戰經驗和探索新技術的地方。
                </p>
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-gray-600">文章總數</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">標籤數量</span>
